...
function ViewModel(params) {
    ...
    self.select = function() {
        ...
        self.output = this;
        self.trigger.call(this, 'selectedarchiveapprovedimageid');
    };
...
ViewModel.prototype.id = 'archiveapprovedimageslistid';
...
exports.register = function () {
    ko.components.register('c-archiveapprovedimageslistid', {
        viewModel: {
