...
exports.register = function () {
    ...
    require('./c-archiveallimageslistid').register();
    require('./c-archiveallworkerslistid').register();
    require('./c-archiveapprovedimageslistid').register();
    require('./c-archiveapprovedimagedetailsid').register();
    require('./c-archiveannotatedimageslistid').register();
    require('./c-archiveannotatedimagedetailsid').register();
                                                                                };
