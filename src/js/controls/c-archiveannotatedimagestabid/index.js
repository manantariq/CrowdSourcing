...
ViewModel.prototype.id = 'archiveannotatedimagestabid';
ViewModel.prototype.children = [
    'archiveannotatedimageslistid' // Annotated Images
    ,'archiveannotatedimagedetailsid' // Image Details
];

exports.register = function () {
    ko.components.register('c-archiveannotatedimagestabid', {
        viewModel: {
