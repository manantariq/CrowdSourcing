...
ViewModel.prototype.id = 'campaignlistpageid';
ViewModel.prototype.children = [
    'runningcampaignslistid' // Running Campaigns
    ,'readycampaignslistid' // Ready Campaigns
];

exports.register = function () {
    ko.components.register('c-campaignlistpageid', {
        viewModel: {
