...
ViewModel.prototype.id = 'archiveapprovedimagestabid';
ViewModel.prototype.children = [
    'archiveapprovedimageslistid' // Approved Images
    ,'archiveapprovedimagedetailsid' // Image Details
];

exports.register = function () {
    ko.components.register('c-archiveapprovedimagestabid', {
        viewModel: {
